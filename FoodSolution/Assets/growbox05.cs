...
public class growbox05 : MonoBehaviour {
    ...
    void OnClick()
    {
        ...
        box[1].transform.localPosition = new Vector3(-423, -64, 0); //메인 카메라와 ngui의 카메라가 다름
        PlayerPrefs.SetInt("SproutPostionX5", -423);
        PlayerPrefs.SetInt("SproutPostionY5", -64);
        PlayerPrefs.SetInt("fullSprout", 5);
    }
}
