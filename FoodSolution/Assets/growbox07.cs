...
public class growbox07 : MonoBehaviour {
    ...
    void OnClick()
    {
        ...
        box[1].transform.localPosition = new Vector3(727, -64, 0); //메인 카메라와 ngui의 카메라가 다름
        PlayerPrefs.SetInt("SproutPostionX7", 727);
        PlayerPrefs.SetInt("SproutPostionY7", -64);
        PlayerPrefs.SetInt("fullSprout", 7);
    }
}
