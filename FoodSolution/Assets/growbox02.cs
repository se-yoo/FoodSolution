...
public class growbox02 : MonoBehaviour {
    ...
    void OnClick()
    {
        ...
        box[1].transform.localPosition = new Vector3(133, 407, 0); //메인 카메라와 ngui의 카메라가 다름
        PlayerPrefs.SetInt("SproutPostionX2", 133);
        PlayerPrefs.SetInt("SproutPostionY2", 407);
        PlayerPrefs.SetInt("fullSprout", 2);
    }
}
