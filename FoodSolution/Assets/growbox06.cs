...
public class growbox06 : MonoBehaviour {
    ...
    void OnClick()
    {
        ...
        box[1].transform.localPosition = new Vector3(133, -64, 0); //메인 카메라와 ngui의 카메라가 다름
        PlayerPrefs.SetInt("SproutPostionX6", 133);
        PlayerPrefs.SetInt("SproutPostionY6", -64);
        PlayerPrefs.SetInt("fullSprout", 6);
    }
}